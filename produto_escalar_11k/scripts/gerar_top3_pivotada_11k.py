...
DIR_11K = DIR_SCRIPT.parent
DIR_ROOT = DIR_11K.parent

DIR_BASE = DIR_11K / "arquivos_base"
DIR_SAIDA = DIR_11K / "saida"
...
ARQ_EMBRAPA = DIR_ROOT / "produto_escalar_metricas" / "arquivos_base" / "embeddings_embrapa_year_colet.parquet"
